(function() {
    function na(k, m) { k.prototype = bb(m.prototype);
        k.prototype.constructor = k;
        k.base = m.prototype }

    function bb(k) {
        function m() {}
        m.prototype = k; return new m }
    ...
    function $(k, m) { var v = !1;
        0 > k && (v = !0, k *= -1);
        k = "" + k; for (m = m ? m : 1; k.length < m;) k = "0" + k; return v ? "-" + k : k }

    function Ea(k) { if (!k) return k;
        k = k.replace(/^\s\s*/, ""); for (var m = /\s/, v = k.length; m.test(k.charAt(--v));); return k.slice(0, v + 1) }
    ...
    function P(k) { var m = ((k & 16711680) >> 16).toString(16),
            v = ((k & 65280) >> 8).toString(16);
        k = ((k & 255) >> 0).toString(16);
        m = 2 > m.length ? "0" + m : m;
        v = 2 > v.length ? "0" + v : v;
        k = 2 > k.length ? "0" + k : k; return "#" + m + v + k }
        ...
        if (isNaN(u)) {
            try {
                ...
                if (!va) { var qa = document.body;
                    ...
                    va.innerHTML = ""; var D = document.createTextNode("Mpgyi");
                    va.appendChild(D);
                    qa.appendChild(va) }
                va.style.display = "";
    ...
    function V(k, m, v, u, y) {
        ...
        u.push([k, m, v, y]);
        return k.addEventListener ? (k.addEventListener(m, v, y), v) : k.attachEvent ? (u = function(m) { m = m || window.event;
            m.preventDefault = m.preventDefault || function() { m.returnValue = !1 };
            m.stopPropagation = m.stopPropagation || function() { m.cancelBubble = !0 };
            v.call(k, m) }, k.attachEvent("on" +
            m, u), u) : !1
    }
    ...
    function fb(k) {
        ...
        if (!k._dropdownMenu && k.exportEnabled && u) {
            ...
            V(k._dropdownMenu, "blur", function() { ta(k._dropdownMenu);
                k._dropDownCloseTime = new Date }, k.allDOMEventHandlers, !0);
            ...
            V(v, "click", function() { k.print();
                ta(k._dropdownMenu) }, k.allDOMEventHandlers, !0);
            v = document.createElement("div");
            v.style.cssText = "padding: 12px 8px 12px 8px";
            v.innerHTML =
            ...
            V(v, "mouseover", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0);
            V(v, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0);
            V(v, "click", function() { k.exportChart({ format: "jpeg", fileName: k.exportFileName });
                ta(k._dropdownMenu) }, k.allDOMEventHandlers, !0);
            v = document.createElement("div");
            v.style.cssText = "padding: 12px 8px 12px 8px";
            ...
            V(v, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0);
            V(v, "click", function() { k.exportChart({ format: "png", fileName: k.exportFileName });
                ta(k._dropdownMenu) }, k.allDOMEventHandlers, !0)
        }
    }
    ...
    function Ka(k, m, v) { if (u && Ya) { var s = k.getContext("2d");
            ...
            k.width = m * ga;
            k.height = v * ga;
            Pa !== La && (k.style.width = m + "px", k.style.height = v + "px", s.scale(ga, ga)) } else k.width = m, k.height = v }
    ...
    function Qa(k, m, v, s, u) { if (null === k || "undefined" === typeof k) return "undefined" === typeof v ? m : v;
        k = parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? m / 100 : 1); "undefined" !== typeof s && (k = Math.min(s, k), "undefined" !== typeof u && (k = Math.max(u, k))); return !isNaN(k) && k <= m && 0 <= k ? k : "undefined" === typeof v ? m : v }
    ...
    function ia(k, m) { ia.base.constructor.call(this, "TextBlock", null, m, null, null);
        this.ctx = k;
        this._isDirty = !0;
        this._wrappedText = null;
        this._initialize() }

    function Ra(k, m) { Ra.base.constructor.call(this, "Toolbar", "toolbar", m, null, k);
        this.chart = k;
    ...
    function Ga(k, m, v) { Ga.base.constructor.call(this, "Subtitle", "subtitles", m, v, k);
        this.chart = k;
        this.canvas = k.canvas;
        this.ctx = this.chart.ctx;
    ...
    (function() {
        ...
        J._fTWm = function(k) { if ("undefined" === typeof J.pro.sCH && !ab) try { var m = k[J.fSDec(J.obj.cntx)];
                m[J.fSDec(J.obj.txtBl)] = J.fSDec(J.obj.tp);
                m[J.fSDec(J.obj.fnt)] = 11 + J.fSDec(J.obj.fntStr);
                m[J.fSDec(J.obj.fSy)] = J.fSDec(J.obj.grClr);
                m[J.fSDec(J.obj.fTx)](J.fSDec(J.obj.trVs), 2, k.height - 11 - 2) } catch (v) {} }
    })();
    var eb = function() { var k = !1; try { var m = Object.defineProperty && Object.defineProperty({}, "passive", { get: function() { k = !0; return !1 } });
                window.addEventListener && (window.addEventListener("test", null, m), window.removeEventListener("test", null, m)) } catch (v) { k = !1 } return k }(),
        Wa = {},
        va = null,
        jb = function() { this.ctx.clearRect(0, 0, this.width, this.height);
            ...
            for (var L = 0; E && L < E.length; L++)
                if (m = E[L], "." === m && 0 > N) N = L;
                    ...
                    if ("%" === m) D *= 100;
                            ...
                            1]) { D /= Math.pow(1E3, m.length - 1);
                        N = L + m.length - 1; continue } else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || (Q = !0);
        ...
        Ma = function(k) { var m = 0,
                v = 0;
            k = k || window.event;
            k.offsetX || 0 === k.offsetX ? (m = k.offsetX, v = k.offsetY) : k.layerX || 0 == k.layerX ? (m = k.layerX, v = k.layerY) : (m = k.pageX - k.target.offsetLeft, v = k.pageY - k.target.offsetTop); return { x: m, y: v } },
        Ya = !0,
    ...
    W.prototype.setOptions = function(k, m) { if (pa[this._defaultsKey]) { var v = pa[this._defaultsKey],
                s; for (s in v) "publicProperties" !== s && v.hasOwnProperty(s) && (this[s] = k && s in k ? k[s] : m && s in m ? m[s] : v[s]) } else Fa && window.console && console.log("defaults not set") };
    ...
    W.prototype.createUserOptions = function(k) {
        if ("undefined" !== typeof k || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                this.parent.createUserOptions(), this.isOptionsInArray) { this.parent.options[this.optionsName] || (this.parent.options[this.optionsName] = []); var m = this.parent.options[this.optionsName],
                    s = m.length;
                this.options._isPlaceholder || (Ba(m), s = m.indexOf(this.options));
                this.options = "undefined" === typeof k ? {} : k;
                m[s] = this.options } else this.options = "undefined" === typeof k ? {} : k, k = this.parent.options, this.optionsName ? m = this.optionsName : (m = this._defaultsKey) && 0 !== m.length ? (s = m.charAt(0).toLowerCase(), 1 < m.length && (s = s.concat(m.slice(1))),
                m = s) : m = void 0, k[m] = this.options
    };
    W.prototype.remove = function(k) { k = "undefined" === typeof k ? !0 : k; if (this.isOptionsInArray) { var m = this.parent.options[this.optionsName];
            Ba(m); var s = m.indexOf(this.options);
            0 <= s && m.splice(s, 1) } else delete this.parent.options[this.optionsName];
    ...
    W.prototype.trackChanges = function(k) { if (!this.sessionVariables) throw "Session Variable Store not set";
    ...
    W.prototype.removeEventListener = function(k, m) { if (k && m && this._eventListeners[k])
    ...
    ia.prototype.measureText = function() { this._lineHeight = Va(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock";
    ...
    y = Na.Chart = function() {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Aa(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Aa(this._preRenderCtx), u ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = sa(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    this.overlaidCanvas = sa(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
                        ...
                        this.allDOMEventHandlers), V(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), V(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), V(this.overlaidCanvas, "mousedown", function(a) { b._mouseEventHandler(a);
                        ta(b._dropdownMenu) }, this.allDOMEventHandlers), V(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), V(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" :
                        "touchstart",
        ...
        function aa(a, d, c) { aa.base.constructor.call(this, "Crosshair", "crosshair", d, null, c);
            this.chart = a;
            this.ctx = this.chart.ctx;
            this.axis = c;
        ...
        m.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (!this._zoomButton) {
                    ...
                    V(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, ua(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, ua(a, a._zoomButton, "pan"));
        ...
        m.prototype.renderElements = function() {
            ...
            this.renderCount++;
            Fa && (n = this, setTimeout(function() { var a = document.getElementById("ghostCanvasCopy");
                a && (Ka(a, n.width, n.height), a.getContext("2d").drawImage(n._eventManager.ghostCanvas, 0, 0)) }, 2E3));
            ...
            for (var a = "", d = 0; d < this.data.length; d++)
                if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= m._supportedChartTypes.indexOf(a.type)) {
                    for (var c = null, b = !1, e = null, f = !1, p = 0; p < this.plotInfo.plotTypes.length; p++)
                        if (this.plotInfo.plotTypes[p].type === a.type) { b = !0;
                            c = this.plotInfo.plotTypes[p]; break }
                    b || (c = { type: a.type, totalDataSeries: 0, plotUnits: [] }, this.plotInfo.plotTypes.push(c));
                    for (p = 0; p <
                        c.plotUnits.length; p++)
                        if (c.plotUnits[p].axisYType === a.axisYType && c.plotUnits[p].axisXType === a.axisXType && c.plotUnits[p].axisYIndex === a.axisYIndex && c.plotUnits[p].axisXIndex === a.axisXIndex) { f = !0;
                            e = c.plotUnits[p]; break }
                    f || (e = {
                        type: a.type,
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = !1, l = !1, A = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    for (r =
                        ...
                        b > c.max && (c.max = b);
                        if (0 < r) {
                            if (a.axisX.logarithmic) { var t = b / n.dataPoints[r - 1].x;
                                1 > t && (t = 1 / t);
                                c.minDiff > t && 1 !== t && (c.minDiff = t) } else t = b - n.dataPoints[r - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t);
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, p, l = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    for (n = 0; n < h.dataPoints.length; n++) {
                        ...
                        if (!(b < m) || r) { if (!r && (r = !0, 0 < n)) { n -= 2;
                                g = k; continue } if (b > t && !q) q = !0;
                            else if (b > t && q) continue;
                            h.dataPoints[n].label && (a.axisX.labels[b] = h.dataPoints[n].label);
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b); if (c.viewPortMin === b && e)
                ...
                for (p = 0; p < this._axes.length; p++)
                    if (this._axes[p].dataInfo._dataRanges) {
                        ...
                        if (this._axes[p].dataInfo.dataPointYPositiveSums) {
                            ...
                            n = h;
                            for (l in q)
                                if (q.hasOwnProperty(l) && !isNaN(l) && (r = q[l], !s(r))) { var g = Math.floor((r - A) / b);
                                    r < n[g].min && (n[g].min = r);
                                    r > n[g].max && (n[g].max = r) }
                            delete this._axes[p].dataInfo.dataPointYPositiveSums
                        }
                        if (this._axes[p].dataInfo.dataPointYNegativeSums) { q = this._axes[p].dataInfo.dataPointYNegativeSums;
                            n = h; for (l in q) q.hasOwnProperty(l) && !isNaN(l) && (r = -1 * q[l], s(r) || (g = Math.floor((r - A) / b), r < n[g].min && (n[g].min = r), r > n[g].max && (n[g].max = r)));
                            delete this._axes[p].dataInfo.dataPointYNegativeSums }
                        for (l = 0; l < h.length -
                            1; l++)
                            if (n = h[l].max, isFinite(n))
                                for (; l < h.length - 1;)
                                    if (A = h[l + 1].min, isFinite(A)) { r = A - n;
                                        r > b && f.push({ diff: r, start: n, end: A }); break } else l++;
        ...
        m.prototype._touchEventHandler = function(a) {
            if (a.changedTouches &&
                ...
                if (!(c && 1 < c.length)) {
                    e = Ma(b);
                    e.time = new Date;
                    try { var p = e.y - this._lastTouchData.y,
                            f = e.time - this._lastTouchData.time; if (1 < Math.abs(p) && this._lastTouchData.scroll || 5 < Math.abs(p) && 250 > f) this._lastTouchData.scroll = !0 } catch (l) {}
        ...
        m.prototype._plotAreaMouseDown = function(a, d) { this.isDrag = !0;
        ...
        m.prototype.renderLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var n = h.dataPoints,
                        r = "solid";
                    if (c.setLineDash) { var q = N(h.nullDataLineDashType, h.lineThickness),
                            r = h.lineDashType,
        ...
        m.prototype.renderSpline = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var n = h.dataPoints,
                        r = "solid";
                    if (b.setLineDash) { var q = N(h.nullDataLineDashType, h.lineThickness),
                            r = h.lineDashType,
                            g = N(r, h.lineThickness);
                        b.setLineDash(g) }
                    var w = h.id;
                            ...
                            if (t = n[m].getTime ? n[m].x.getTime() : n[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))
                                if ("number" !== typeof n[m].y) 0 < m && !x && (h.connectNullData ? b.setLineDash && (0 < s.length && (h.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q, r = h.nullDataLineDashType) : (d(s), s = [])), x = !0;
                                    ...
                                    m < n.length - 1 && (k !== (n[m].lineColor || w) || r !== (n[m].lineDashType || h.lineDashType)) && (k = n[m].lineColor || w, s[s.length - 1].newStrokeStyle = k, b.setLineDash && (n[m].lineDashType ? (r = n[m].lineDashType, s[s.length - 1].newLineDashArray = N(r, h.lineThickness)) : (r = h.lineDashType, s[s.length - 1].newLineDashArray =
                                        g)));
                                    if (0 < n[m].markerSize || 0 < h.markerSize) { var B = h.getMarkerProperties(m, t, x, b);
                                        p.push(B);
                                        F = P(F);
                                        u && p.push({ x: t, y: x, ctx: e, type: B.type, size: B.size, color: F, borderColor: F, borderThickness: B.borderThickness }) }(n[m].indexLabel || h.indexLabel || n[m].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: n[m], dataSeries: h, point: { x: t, y: x }, direction: 0 > n[m].y === a.axisY.reversed ? 1 : -1, color: w });
                                    x = !1
                                }
                    d(s)
                }
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                else if (r = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var C = "undefined" !== typeof f[b] ? f[b] : 0;
                                    r -= C;
                                    B = q - C;
                                    f[b] = C + (B - r) } else C = p[b] ? p[b] : 0, B = r + C, r = q + C, p[b] = C + (B - r);
                    ...
                    if (0 < t.length)
                        for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                else if (r = a.axisY.convertValueToPixel(r), 0 <= t[h].y) { var C = "undefined" !== typeof f[b] ? f[b] : 0;
                                    r -= C;
                                    B = q - C;
                                    a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.y1 - r) && (r = e.y1);
                                    f[b] = C + (B - r) } else C = "undefined" !== typeof p[b] ?
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() :
                                ...
                                else if (n = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var C = f[b] ? f[b] : 0;
                                    B = q + C;
                                    n += C;
                                    f[b] = C + (n - B) } else C = p[b] ? p[b] : 0, B = n - C, n = q - C, p[b] = C + (n - B);
                                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                var F = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    B = F + g << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) { l[b] = z + (l[b] ? l[b] : 0); if (0 >= l[b]) continue;
                                    z = f[b] ? f[b] : q;
                                    f[b] = n = a.axisY.convertValueToPixel(l[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) A[b] = z + (A[b] ? A[b] : 0), n = p[b] ? p[b] :
                                    q, p[b] = z = a.axisY.convertValueToPixel(A[b]);
                                else if (n = a.axisY.convertValueToPixel(z), 0 <= t[h].y) { var C = f[b] ? f[b] : 0;
                                    z = q + C;
                                    n += C;
                                    a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.x2 - n) && (n = e.x2);
                                    f[b] = C + (n - z) } else C = p[b] ? p[b] : 0, z = n - C, n = q - C, a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.x1 - z) && (z = e.x1), p[b] = C + (n - z);
                                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
        ...
        m.prototype.renderStackedArea = function(a) {
            function d() { if (!(1 > h.length)) { for (0 < C.lineThickness && b.stroke(); 0 < h.length;) { var a = h.pop();
                        b.lineTo(a.x, a.y);
                        u && s.lineTo(a.x, a.y) }
                    b.closePath();
        ...
        m.prototype.renderStackedArea100 = function(a) {
            function d() { for (0 < C.lineThickness && b.stroke(); 0 < h.length;) { var a = h.pop();
                    b.lineTo(a.x, a.y);
                    u && z.lineTo(a.x, a.y) }
                b.closePath();
                b.globalAlpha = C.fillOpacity;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < n.length) {
                        ...
                        b.lineWidth = C.lineThickness;
                        t = "solid";
                        if (b.setLineDash) { var R = N(C.nullDataLineDashType, C.lineThickness);
                            t = C.lineDashType; var E = N(t, C.lineThickness);
                            b.setLineDash(E) }
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                fa = null,
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z)))
                                if ("number" !== typeof fa.y) C.connectNullData || (Z || s) || d(), Z = !0;
                                    ...
                                    g = a.axisX.convertValueToPixel(f);
                                    var ba = k[f] ? k[f] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { r[f] = ma + (r[f] ? r[f] : 0); if (0 >= r[f] && a.axisY.logarithmic) continue;
                                        w = a.axisY.convertValueToPixel(r[f]) } else w = a.axisY.convertValueToPixel(ma), w -= ba;
                                    h.push({ x: g, y: x - ba });
                                    k[f] = x - w;
                                    ...
                                    if (0 <= C.dataPointIndexes[f]) { var G = C.dataPointIds[C.dataPointIndexes[f]];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < n.length) {
                        ...
                        var F = "solid",
                            B;
                        if (b.setLineDash) { var C = N(h.nullDataLineDashType, h.lineThickness),
                                F = h.lineDashType;
                        ...
                        for (g = !1; r < n.length; r++)
                            if (q = n[r].x.getTime ? n[r].x.getTime() : n[r].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))
                                if (null !== n[r].y && n[r].y.length && "number" === typeof n[r].y[0] && "number" ===
                                    ...
                                    if (0 !== n[r].markerSize && (0 < n[r].markerSize || 0 < h.markerSize)) { var E = h.getMarkerProperties(r, q, g, b);
                                        f.push(E); var S = P(D);
        ...
        var Y = function(a, d, c, b, e, f, p, l, k) {
            if (!(0 > c)) {
                "undefined" === typeof l &&
                    (l = 1);
                if (!u) { var h = Number((p % (2 * Math.PI)).toFixed(8));
        ...
        m.prototype.renderPie = function(a) {
            function d() {
                if (h &&
                    ...
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        l.midAngle = f;
                        if (l.midAngle > Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t) { if (0 === a || g[c].midAngle > l.midAngle) c = e;
                            a++ } else if (l.midAngle > 3 * Math.PI / 2 - t && l.midAngle < 3 * Math.PI / 2 + t) { if (0 === b || g[d].midAngle > l.midAngle) d = e;
                            b++ }
            ...
            function p() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    if ("inside" !== h.indexLabelPlacement) {
                        u = C * v;
                        for (a = 0; a < n.length; a++) { var p = g[a];
                        ...
                        for (var s, t, a = 0; a < n.length; a++) {
                            ...
                            if (null !== B) {
                                ...
                                var y = 0,
                                    y = b(s, t) -
                                    m;
                                if (0 > y) { for (var F = t = 0, J = 0; J < n.length; J++) J !== a && g[J].hemisphere === p.hemisphere && (g[J].indexLabelTextBlock.y < p.indexLabelTextBlock.y ? t++ : F++);
                                    t = y / (t + F || 1) * F; var F = -1 * (y - t),
                                        I = J = 0; "right" === p.hemisphere ? (J = f(a, t), F = -1 * (y - J), I = f(B, F), +I.toFixed(x) < +F.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(a, -(F - I))) : (J = f(B, t), F = -1 * (y - J), I = f(a, F), +I.toFixed(x) < +F.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(B, -(F - I))) }
                            }
                        }
                    } else
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 !== y) {
                    ...
                    this.pieDoughnutClickHandler = function(a) { k.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && k._animator.animate(0, 500, function(a) { c(a);
                            l() })) };
                    d();
                    p();
                    p();
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (b = 0; b < n.length; b++) { var c = 0 === b ? g[b].startAngle : d,
                                d = c + (g[b].endAngle - g[b].startAngle),
                                e = !1;
                            d > a && (d = a, e = !0); var f = n[b].color ? n[b].color : h._colorSet[b % h._colorSet.length];
                            d > c && Y(k.plotArea.ctx, g[b].center, g[b].radius, f, h.type, c, d, h.fillOpacity, g[b].percentInnerRadius); if (e) break }
                        l()
                    }, function() { k.disableToolTip = !1;
                        k._animator.animate(0, k.animatedRender ? 500 : 0, function(a) { c(a);
                            l() }) })
                }
            }
        };
        ...
        m.prototype.renderFunnel = function(a) {
            function d() {
                for (var a =
                        0, b = [], c = 0; c < x.length; c++) { if ("undefined" === typeof x[c].y) return -1;
            ...
            function e() {
                ...
                for (var g, h = M - $ - V / 2, h = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth >
                        h ? h : t.indexLabelMaxWidth : h, l = H.length - 1; 0 <= l; l--) { g = x[H[l].id];
                    c = H[l];
                    d = c.textBlock;
                    b = (a = q(l) < O.length ? H[q(l)] : null) ? a.textBlock : null;
                    c = c.height;
                    a && d.y + c + da > b.y && (e = !0);
                    c = g.indexLabelMaxWidth || h; if (c > h || 0 > c) c = h;
                    f.push(c) }
                if (e)
            ...
            function p() {
                ...
                function b() {
                    ...
                    for (l = O.length - 1; 0 < l; l--)
                        if (!H[l].isDirty) {
                            ...
                            if (H[l].textBlock.y < H[e].textBlock.y + H[e].height) { d = d || l;
                                f = l; for (h = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + da;) { a = a || H[f].textBlock.y + H[f].height;
                                    h += H[f].height;
                                    h += da;
                                    f = e; if (0 >= f) { f = 0;
                                        h += H[f].height; break }
                                    e = r(f); if (0 > e) { f = 0;
                                        h += H[f].height; break } } if (f != l) { g = H[f].textBlock.y;
                                    a -= g;
                                    a = h - a;
                                    g = c(a, d, f); break } }
                        }
                ...
                for (var d, e, f, g, h, p, k = 1, n = 0; n < 2 * k; n++) { for (var m = H.length - 1; 0 <= m && !(0 <= r(m) && r(m), f = H[m], g = f.textBlock, p = (h = q(m) < O.length ? H[q(m)] : null) ? h.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (h && e + d + da > +p.y.toFixed(6)) && (d = g.y + d + da - p.y, e = a(m, -d), e < d && (0 < e && (d -= e), e = a(q(m), d), e != d))); m--);
                    b() }
            }
            ...
            function k(a, b, c) {
                ...
                if (0 === Y.length) l = ga;
                else { e = F * (1 != Y.length || 0 != Y[0] && Y[0] != O.length - 1 ? 2 : 1) / h(); for (var q = 0; q < O.length; q++) { if (1 == Y.length && 0 == Y[0]) { if (0 === q) { l.push(ga[q]);
                                d = p; continue } } else 0 === q && (d = -1 * p);
                        l.push(ga[q] + d); if (0 <= Y.indexOf(q) || q < O.length && 0 <= Y.indexOf(q + 1)) d += e } }
                g = function() {
            ...
            function g(a) { for (var b, c = 0; c < x.length; c++)
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    ...
                    if (-1 !== R) {
                        ...
                        this.funnelPyramidClickHandler = function(a) { var b = -1; if (!ha && !y.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = t.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? x[x.length - 1 - a].exploded = x[x.length - 1 - a].exploded ? !1 : !0 : x[a].exploded = x[a].exploded ? !1 : !0;
                                k(y, b, 500) } };
                        return {
                            source: P,
                            dest: this.plotArea.ctx,
                            animationCallback: function(a, b) { L.fadeInAnimation(a, b);
        ...
        m.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                f.download = c;
                f.href = b;
                if ("undefined" !== typeof Blob && new Blob) { for (var p = b.replace(/^data:[a-z\/]*;base64,/, ""), p = atob(p), l = new ArrayBuffer(p.length), l = new Uint8Array(l), k = 0; k < p.length; k++) l[k] = p.charCodeAt(k);
                    d = new Blob([l.buffer], { type: "image/" + d }); try { window.navigator.msSaveBlob(d, c), e = !0 } catch (h) { f.dataset.downloadurl = [a, f.download, f.href].join(":"), f.href = window.URL.createObjectURL(d) } }
                if (!e) try {
        ...
        m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") ||
                ...
                do {
                    ...
                    if (c.percentFormatString) k = c.percentFormatString;
                            ...
                            h = Math.max(Math.ceil(Math.log(1 / Math.abs(p)) / Math.LN10), 2); if (isNaN(h) || !isFinite(h)) h = 2; for (var n = 0; n < h; n++) k += "#";
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try { var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    g && 0 < g.length && (h = Ea(g[2]), a = Ea(g[1])) } catch (l) {}
                g = null;
        ...
        D.prototype.createLabels = function() {
            ...
            for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock;
                a.maxWidth = f;
                a.maxHeight = p; var m = a.measureText();
                k = m.height }
            e = [];
            q = r = 0;
        ...
        D.prototype.renderLabelsTicksAndTitle = function() {
            ...
            if ("undefined" === typeof this.options.interval) {
                if ("bottom" ===
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        ...
                        this._labels = c
                    } else { for (h = 0; h < this._labels.length; h++) r = this._labels[h], r.position < this.viewportMinimum || (k = r.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += k);
                        c > this.lineCoordinates.width * e && this.labelAutoFit && (d = !0) }
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], n, l = this.viewportMaximum, m = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) { r = this._labels[h]; if (r.position < this.viewportMinimum) break;
            ...
            if ("bottom" === this._position) {
                ...
                "inside" === this.tickPlacement &&
                    this.chart.addEventListener("dataAnimationEnd", function() { for (h = 0; h < a._labels.length; h++)
                            if (r = a._labels[h], !(r.position < a.viewportMinimum || r.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(r.position), a.tickThickness)) { a.ctx.lineWidth = a.tickThickness;
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() { for (h = 0; h < a._labels.length; h++)
                        if (r = a._labels[h], !(r.position < a.viewportMinimum || r.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(r.position), a.tickThickness)) { a.ctx.lineWidth = a.tickThickness;
        ...
        D.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                ...
                if (!k) {
                    ...
                    this.ctx.clip();
                    for (b = 0; b < l.length; b++) h = l[b], h.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { this.ctx.save();
                        this.ctx.beginPath();
                        this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                        this.ctx.clip(); for (e = 0; e < l.length; e++) h = l[e], h.showOnTop && h.render();
                        this.ctx.restore() }, h)) : h.render();
        ...
        D.prototype.convertPixelToValue = function(a) {
            ...
            if (this.logarithmic) {
                ...
                else if (b < e[c].endValue - this.conversionParameters.minimum) { b -= e[c].endValue - this.conversionParameters.minimum; if (b > -1 * e[c].size) { a += (e[c].endValue - e[c].startValue) * (0 === e[c].size ? 1 : b / e[c].size) + b; break } else a -= e[c].endValue - e[c].startValue - e[c].size;
                    b += e[c].size;
                    d = !1 } else break;
        ...
        D.prototype.setViewPortRange = function(a,
            d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d);
        ...
        D.generateValueFormatString = function(a, d) { var c = "#,##0.",
                b = d;
        ...
        D.getNiceNumber = function(a, d) { var c = Math.floor(Math.log(a) / Math.LN10),
                b = a / Math.pow(10, c),
        ...
        U.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    ...
                    else if ("wavy" === this.type) { m = b;
                    h = e;
                    f = 0.5;
                    n = (l - h) / a / 3; for (var q = 0; q < n; q++) this.ctx.bezierCurveTo(m + f * a, h + a, m + f * a, h + 2 * a, m, h + 3 * a), h += 3 * a, f *= -1;
                    this.ctx.bezierCurveTo(m + f * a, h + a, m + f * a, h + 2 * a, m, h + 3 * a);
                    m = k;
                    f *= -1;
                    this.ctx.lineTo(m, h); for (q = 0; q < n; q++) this.ctx.bezierCurveTo(m + f * a, h - a, m + f * a, h - 2 * a, m, h - 3 * a), h -= 3 * a, f *= -1 } else {
                    if ("zigzag" ===
                        this.type) { f = -1;
                        h = e + a;
                        m = b + a;
                        n = (l - h) / a / 2; for (q = 0; q < n; q++) this.ctx.lineTo(m, h), m += 2 * f * a, h += 2 * a, f *= -1;
                        this.ctx.lineTo(m, h);
                        m += k - b; for (q = 0; q < n + 1; q++) this.ctx.lineTo(m, h), m += 2 * f * a, h -= 2 * a, f *= -1;
                    ...
                    h = e - a;
                    m = b + a;
                    n = (k - m) / a / 2; for (q = 0; q < n; q++) this.ctx.lineTo(m, h), h += 2 * f * a, m += 2 * a, f *= -1;
                    this.ctx.lineTo(m, h);
                    h += l - e; for (q = 0; q < n + 1; q++) this.ctx.lineTo(m, h), h += 2 * f * a, m -= 2 * a, f *= -1;
        ...
        aa.prototype.hide = function() { this.chart.resetOverlayedCanvas();
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if (y) { if ("axisX" === this.parent.type)
        ...
        $.prototype._updateToolTip = function(a, d, c) {
            ...
            if (!this.chart.disableToolTip) {
                if ("undefined" === typeof a || "undefined" === typeof d) { if (isNaN(this._prevX) || isNaN(this._prevY)) return;
                    a = this._prevX;
                    d = this._prevY } else this._prevX = a, this._prevY =
                    d;
                var b = null,
                    e = null,
                    f = [],
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        var l = [];
                        if (this.chart.axisX)
                            for (var m = 0; m < this.chart.axisX.length; m++) { for (var k = this.chart.axisX[m].convertPixelToValue({ y: d }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
                                h = null }
                        if (this.chart.axisX2)
                            for (m =
                                0; m < this.chart.axisX2.length; m++) { k = this.chart.axisX2[m].convertPixelToValue({ y: d });
                                h = null; for (b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)(h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
                                h = null }
                    } else {
                        l = [];
                        if (this.chart.axisX)
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (!s(h) && !s(h.dataPoint) && !s(h.dataPoint.y))
                            if (h.dataSeries.axisY)
                                if (0 <
                                    h.dataPoint.y.length) { for (b = c = 0; b < h.dataPoint.y.length; b++) h.dataPoint.y[b] < h.dataSeries.axisY.viewportMinimum ? c-- : h.dataPoint.y[b] > h.dataSeries.axisY.viewportMaximum && c++;
                                    c < h.dataPoint.y.length && c > -h.dataPoint.y.length && f.push(h) } else "column" === e.type || "bar" === e.type ? 0 > h.dataPoint.y ? 0 > h.dataSeries.axisY.viewportMinimum && h.dataSeries.axisY.viewportMaximum >= h.dataPoint.y && f.push(h) : h.dataSeries.axisY.viewportMinimum <= h.dataPoint.y && 0 <= h.dataSeries.axisY.viewportMaximum && f.push(h) : "bubble" === e.type ?
