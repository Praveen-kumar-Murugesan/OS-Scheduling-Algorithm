(function(b) {
    ...
    function q(b, x, q, v) { b.hasOwnProperty(x) || (b[x] = v.apply(null, q)) }
    b = b ? b._modules : {};
    q(b, "Extensions/Ajax.js", [b["Core/Globals.js"], b["Core/Utilities.js"]], function(b, x) {
        ...
        b.ajax = function(b) {
            var m =
                q(!0, { url: !1, type: "get", dataType: "json", success: !1, error: !1, data: !1, headers: {} }, b);
            ...
            v(m.headers, function(b, m) { r.setRequestHeader(m, b) });
            r.onreadystatechange = function() {
                if (4 === r.readyState) {
                    if (200 === r.status) {
                        var b = r.responseText;
                        if ("json" ===
                            m.dataType) try { b = JSON.parse(b) } catch (C) { m.error && m.error(r, C); return }
                        return m.success && m.success(b)
                    }
                    m.error && m.error(r, r.responseText)
                }
            };
            try { m.data = JSON.stringify(m.data) } catch (O) {}
            r.send(m.data || !0)
        };
        b.getJSON = function(q, m) { b.ajax({ url: q, success: m, dataType: "json", headers: { "Content-Type": "text/plain" } }) };
        ...
        function(b, q, H, v, I, m) {
            ...
            q = function() {
                ...
                b.prototype.init = function(a, c, f) {
                    ...
                    this.rawColumns = [];
                    if (this.columns.length) { this.dataFound(); var h = !0 }
                ...
                b.prototype.getColumnDistribution = function() {
                    var a = this.chartOptions,
                        c = this.options,
                        f = [],
                        d = function(a) { return (D[a || "line"].prototype.pointArrayMap || [0]).length },
                    ...
                    var e;
                    (a && a.series || []).forEach(function(a) { g.push(d(a.type || h)) });
                    c.forEach(function(a) { f.push(a.x || 0) });
                    0 === f.length && f.push(0);
                    c.forEach(function(c) {
                        ...
                        L(c, function(a, c) { "x" !== c && f.addColumnReader(a, c) });
                    ...
                    this.valueCount = { global: d(h), xColumns: f, individual: g, seriesBuilders: b, globalPointArrayMap: c }
                };
                ...
                b.prototype.parseCSV = function(a) {
                    function c(a, c, f, d) {
                        ...
                        function g() { e > u || u > m ? (++u, n = "") : (!isNaN(parseFloat(n)) && isFinite(n) ? (n = parseFloat(n), h("number")) : isNaN(Date.parse(n)) ? h("string") : (n = n.replace(/\//g, "-"), h("date")), A.length < t + 1 && A.push([]), f || (A[t][c] = n), n = "", ++t, ++u) }
                        var z = 0,
                            k = "",
                            l = "",
                            p = "",
                ...
                b.prototype.fetchLiveData = function() {
                    function a(h) {
                        function e(e, l, n) {
                            function m() { g && f.liveDataURL === e && (c.liveDataTimeout = setTimeout(a, k)) }
                            ...
                            r({
                                ...
                                error: function(a, c) { 3 > ++b && m(); return d.error && d.error(c, a) }
                            });
                            return !0
                        }
                ...
                b.prototype.parseGoogleSpreadsheet = function() {
                    function a(c) {
                        ...
                        r({
                            ...
                            success: function(d) {
                                c(d);
                                f.enablePolling && setTimeout(function() { a(c) }, 1E3 * (f.dataRefreshRate || 2))
                            },
                            error: function(a, c) { return f.error && f.error(c, a) }
                        })
                    }
                    var c = this,
                        f = this.options,
                ...
                b.prototype.rowsToColumns = function(a) { var c, b; if (a) { var d = []; var h = a.length; for (c = 0; c < h; c++) { var g = a[c].length; for (b = 0; b < g; b++) d[b] || (d[b] = []), d[b][c] = a[c][b] } } return d };
                b.prototype.getData = function() { if (this.columns) return this.rowsToColumns(this.columns).slice(1) };
                b.prototype.parsed = function() { if (this.options.parsed) return this.options.parsed.call(this, this.columns) };
                b.prototype.getFreeIndexes = function(a, c) {
                    var b, d = [],
                        h = [];
                    for (b = 0; b < a; b +=
                        1) d.push(!0);
                    for (a = 0; a < c.length; a += 1) { var g = c[a].getReferencedColumnIndexes(); for (b = 0; b < g.length; b += 1) d[g[b]] = !1 }
            ...
            v.data = function(b, a, c) { return new v.Data(b, a, c) };
            b(H, "init", function(b) {
                var a = this,
                    c = b.args[0] || {},
                    f = b.args[1];
            ...
            var G = function() {
                ...
                b.prototype.read = function(a, b) {
                    ...
                    if ("undefined" === typeof this.name && 2 <= this.readers.length) {
                        ...
                        2 <= h.length && (h.shift(), h.sort(function(a, b) { return a - b }), this.name = a[h.shift()].name)
                    }
                    return d
                };
                b.prototype.addColumnReader = function(a, b) { this.readers.push({ columnIndex: a, configName: b }); "x" !== b && "y" !== b && "undefined" !== typeof b && (this.pointIsArray = !1) };
                b.prototype.getReferencedColumnIndexes = function() {
                    var a,
                        b = [];
                    for (a = 0; a < this.readers.length; a += 1) { var f = this.readers[a]; "undefined" !== typeof f.columnIndex && b.push(f.columnIndex) }
                    return b
                };
                b.prototype.hasReader = function(a) { var b; for (b = 0; b < this.readers.length; b += 1) { var f = this.readers[b]; if (f.configName === a) return !0 } };
                return b
            }();
            v.Data = q;
            return v.Data
